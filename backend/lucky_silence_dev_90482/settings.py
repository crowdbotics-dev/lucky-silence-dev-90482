"""
Django settings for lucky_silence_dev_90482 project.
...
ROOT_URLCONF = 'lucky_silence_dev_90482.urls'
...
WSGI_APPLICATION = 'lucky_silence_dev_90482.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_silence_dev_90482 API",
    "DESCRIPTION": "API documentation for lucky_silence_dev_90482 App",
    "VERSION": "v1",
}
